  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5">
        ...
        {/* Aspect ratio */}
        <div>
          <button type="button" onClick={() => setFormatOpen(!formatOpen)} className="flex items-center justify-between w-full text-sm font-medium mb-3">
          ...
          {formatOpen && (
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button type="button" onClick={() => setAspectRatio("4:3")} className="text-[11px] text-primary hover:underline flex items-center gap-1">
        ...
        {isVideo && (
          <div>
            <button type="button" onClick={() => setDurationOpen(!durationOpen)} className="flex items-center justify-between w-full text-sm font-medium mb-3">
        ...
        {/* Quality / Resolution */}
        <div>
          <button type="button" onClick={() => setQualityOpen(!qualityOpen)} className="flex items-center justify-between w-full text-sm font-medium mb-3">
              ...
              {isVideo ? (
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button type="button" onClick={() => setResolution("2K")} className="text-[11px] text-primary hover:underline flex items-center gap-1">
                      <RotateCcw className="w-3 h-3" /> Сбросить
                    </button>
                  </div>
                  <div className="flex gap-2">
        ...
        {isVideo && (
          <div>
            <button type="button" onClick={() => setSceneOpen(!sceneOpen)} className="flex items-center justify-between w-full text-sm font-medium mb-3">
      ...
      <div className="p-4 border-t border-border flex items-center justify-between">
        <button type="button" onClick={resetAll} className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors">
