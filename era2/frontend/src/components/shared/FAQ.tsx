    ...
    <section className="max-w-6xl mx-auto px-4 py-16">
      <div className="grid md:grid-cols-[1fr_1.5fr] gap-10">
        <div className="space-y-4">
          ...
          <button type="button" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-button border border-border text-sm font-medium hover:bg-muted transition-colors">
