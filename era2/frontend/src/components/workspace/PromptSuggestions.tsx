  ...
  return (
    <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide -mt-1">
      <button type="button"
        ...
        onFocus={(e) => { e.currentTarget.style.color = "var(--text-primary)"; e.currentTarget.style.borderColor = "var(--border-hover)"; }}
        onMouseOut={(e) => { e.currentTarget.style.color = "var(--text-tertiary)"; e.currentTarget.style.borderColor = "var(--border-primary)"; }}
        onBlur={(e) => { e.currentTarget.style.color = "var(--text-tertiary)"; e.currentTarget.style.borderColor = "var(--border-primary)"; }}
      >
        <RotateCcw size={12} />
      </button>
      {suggestions.map((s) => (
        <button type="button"
          ...
          onBlur={(e) => { e.currentTarget.style.color = "var(--text-secondary)"; e.currentTarget.style.borderColor = "var(--border-primary)"; }}
        >
          {s}
        </button>
      ))}
