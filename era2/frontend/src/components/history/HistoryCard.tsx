...
export function HistoryCard({ item, onClick, onToggleFavorite }: Props) {
  ...
  return (
    <div
      ...
      className="group rounded-2xl border border-border bg-card overflow-hidden cursor-pointer transition-all hover:border-[hsl(var(--primary))]/40 hover:scale-[1.01] mb-3 break-inside-avoid text-left w-full"
    >
      {/* Preview */}
