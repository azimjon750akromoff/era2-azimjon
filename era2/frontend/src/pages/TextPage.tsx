            ...
            {msg.role === "assistant" && (
              <div className="flex items-center gap-1 mt-1.5 opacity-0 hover:opacity-100 transition-opacity">
                {[
                  ...
                  <button type="button" key={title} className="w-7 h-7 rounded-md flex items-center justify-center transition-colors" style={{ color: c.textSecondary }} title={title}>
    ...
    >
      <div className="max-w-[780px] mx-auto space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button type="button" onClick={onClose} className="text-sm" style={{ color: c.textSecondary }}>✕</button>
        </div>
        <textarea
          value={value}
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="ml-auto flex gap-2">
            <button type="button" onClick={() => onChange("")} className="px-4 py-1.5 rounded-full text-xs transition-colors" style={{ background: c.pillBg, border: `1px solid ${c.pillBorder}`, color: c.textSecondary }}>
              Очистить
            </button>
            <button type="button" onClick={onClose} className="px-4 py-1.5 rounded-full text-xs text-white font-medium" style={{ background: c.sendActive }}>
              Применить
            </button>
          </div>
        </div>
