  ...
  return (
    <div className="min-w-0">
      ...
      <section className="relative overflow-hidden">
        ...
        <m.div className="relative max-w-4xl mx-auto text-center px-4 pt-16 pb-10 md:pt-20" initial="hidden" animate="show" variants={stagger}>
          <m.p variants={fadeUp} className="text-xs uppercase tracking-[2px] text-primary font-semibold mb-4">Тарифы</m.p>
          <m.h1 variants={fadeUp} className="text-[32px] md:text-[44px] font-bold mb-4">Простые тарифы для каждого</m.h1>
          <m.p variants={fadeUp} className="text-muted-foreground mb-8">Одна подписка — доступ ко всем 90+ нейросетям. Начните бесплатно.</m.p>

          {/* Period toggle */}
          <m.div variants={fadeUp} className="inline-flex rounded-full border border-[hsl(var(--border))] p-1">
            <button type="button"
